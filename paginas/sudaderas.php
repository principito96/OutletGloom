...
$sudaderas = new Sudaderas();
$todos = $sudaderas->mostrar();
$sudaderas = null;
...
<body class="container mt-3 fondo ">
    ...
    <div class="text-center d-block" style="margin-top: 120px;">
        <h1 class="card text-white border-primary bg-info" id="titulo">Sudaderas</h1>
        <h5 class="card text-dark border-info bg-transparent" id="texto3">
            EN ESTA SECCIÓN TE ENCONTRARÁS CON LAS SUDADERAS QUE DISPONEMOS EN ESTA TEMPORADA
        </h5>
    </div>
    ...
    <div class="row" id="tarjeta">
        ...
        <div class="product-card col-md-4">
            ...
            <div id="<?php echo "car".$key->id ?>" class="carousel slide" data-ride="carousel">
                ...
                <div id="botones">
                    <?php                  
                    echo "<form name='b' action='borrarSudadera.php' method='POST' class='form from-inline'>\n";
                    echo "<a href='crearSudaderas.php' class='btn btn-success mr-2'>Crear</a>";
                    echo "<a href='editarSudaderas.php?id={$key->id}' class='btn btn-info mr-2'>Editar</a>";
