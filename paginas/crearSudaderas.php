...
if(isset($_POST['btncrear'])){
    ...
    $estaSudadera=null;
    $_SESSION["mensaje"]="Sudadera creada correctamente.";
...
<body style="background-color:lightblue;text-align:center;">
    <h3 class="text-center my-3">Nueva Sudadera</h3>
    <div class="container my-4">
        ...
        <form name="cm" method="POST" enctype="multipart/form-data" action='<?php echo $_SERVER['PHP_SELF'] ?>'>
            ...
            <div class="row mt-3">
                <div class="col">
                    <b>Selecciona la foto de la sudadera:</b>
            ...
            <div class="row mt-3">
                <div class="col">
                    ...
                    <a href="sudaderas.php" class="btn btn-info">Volver</a>
                </div>
            </div>
