...
if(isset($_POST['btncrear'])){
    ...
    if(is_uploaded_file($_FILES['foto']['tmp_name'])){
        ...
        $esteVestido->setFoto("../Fotos/vestido1.png");
    }
    $esteVestido->setPrecio($precio);
    $esteVestido->setStock($stock);
    $esteVestido->setNombre($nombre);
    $esteVestido->setDescripcion($descripcion);
    $esteVestido->create();

    $esteVestido=null;
    $_SESSION["mensaje"]="Vestido creado correctamente.";
...
<body style="background-color:lightblue;text-align:center;">
    <h3 class="text-center my-3">Nueva vestido</h3>
    <div class="container my-4">
        ...
        <form name="cm" method="POST" enctype="multipart/form-data" action='<?php echo $_SERVER['PHP_SELF'] ?>'>
            ...
            <div class="row mt-3">
                <div class="col">
                    <b>Selecciona la foto del vestido:</b>
