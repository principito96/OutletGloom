...
$vestidos = new Vestidos();
$todos = $vestidos->recuperarTodas();
$vestidos = null;
...
<body class="container mt-3 fondo ">
    ...
    <div class="text-center d-block" style="margin-top: 120px;">
        <h1 class="card text-white border-primary bg-info" id="titulo">Vestidos</h1>
        <h5 class="card text-dark border-info bg-transparent" id="texto3">
            EN ESTA SECCI&Oacute;N NOS ENCONTRAREMOS CON LOS VESTIDOS QUE DISPONEMOS EN STOCK
        </h5>
    </div>
    ...
    <div class="row" id="tarjeta">
        ...
        <div class="product-card col-md-4">
            ...
            <div id="<?php echo "car".$key->id ?>" class="carousel slide" data-ride="carousel">
                ...
                <div id="botones">
                    <?php                  
                    echo "<form name='b' action='borrarVestido.php' method='POST' class='form from-inline'>\n";
                    echo "<a href='crearVestidos.php' class='btn btn-success mr-2'>Crear</a>";
                    echo "<a href='editarVestido.php?id={$key->id}' class='btn btn-info mr-2'>Editar</a>";
